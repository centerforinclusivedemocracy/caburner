...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp: "011", name: "Colusa", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "013", name: "Contra Costa", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "015", name: "Del Norte", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "017", name: "El Dorado", profile: 'vca', vca: '2'},
    { countyfp: "019", name: "Fresno", profile: 'vca', vca: '2'},
    { countyfp: "021", name: "Glenn", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "023", name: "Humboldt", profile: 'vca', vca: '3 & 4'},
    { countyfp: "025", name: "Imperial", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "027", name: "Inyo", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "029", name: "Kern", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "031", name: "Kings", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "033", name: "Lake", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "035", name: "Lassen", profile: 'nonvca', outoforder: "2020 general election vote-by-mail rates are reported by the county as 100%.", vca: '3 & 4'},
    ...
    { countyfp: "045", name: "Mendocino", profile: 'nonvca', vca: '3 & 4'},
    ...
    { countyfp: "049", name: "Modoc", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "051", name: "Mono", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "053", name: "Monterey", profile: 'nonvca', vca: '3 & 4'},
    ...
    { countyfp: "061", name: "Placer", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "063", name: "Plumas", profile: 'vbm', outoforder: "This county is exclusively all vote-by-mail in every election."},
    { countyfp: "065", name: "Riverside", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "067", name: "Sacramento", profile: 'vca', vca: '2'},
    { countyfp: "069", name: "San Benito", profile: 'vca', vca: '3 & 4'},
    { countyfp: "071", name: "San Bernardino", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "073", name: "San Diego", profile: 'vca', vca: '3 & 4'},
    { countyfp: "075", name: "San Francisco", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "077", name: "San Joaquin", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "079", name: "San Luis Obispo", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "081", name: "San Mateo", profile: 'vca', vca: '2'},
    { countyfp: "083", name: "Santa Barbara", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "085", name: "Santa Clara", profile: 'vca', vca: '2'},
    { countyfp: "087", name: "Santa Cruz", profile: 'vca', vca: '3 & 4'},
    { countyfp: "089", name: "Shasta", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "091", name: "Sierra", profile: 'nonvca', outoforder: "This county is exclusively all vote-by-mail in every election."},
    { countyfp: "093", name: "Siskiyou", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "095", name: "Solano", profile: 'nonvca', vca: '3 & 4'},
    ...
    { countyfp: "101", name: "Sutter", profile: 'nonvca',  outoforder: "2020 general election vote-by-mail rates are reported by the county as 100%.", vca: '3 & 4'},
    { countyfp: "103", name: "Tehama", profile: 'nonvca', vca: '3 & 4'},
    { countyfp: "105", name: "Trinity", profile: 'nonvca',  outoforder: "2020 general election vote-by-mail rates are reported by the county as 100%.", vca: '3 & 4'},
    { countyfp: "107", name: "Tulare", profile: 'nonvca', vca: '3 & 4'},
    ...
    { countyfp: "115", name: "Yuba", profile: 'nonvca', vca: '3 & 4'},
  ];
