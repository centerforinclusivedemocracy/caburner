...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp: "003", name: "Alpine", profile: 'lite', outoforder: "This county is exclusively vote-by-mail."},
    ...
    { countyfp: "035", name: "Lassen", profile: 'fullmodel', outoforder: "Vote-by-mail rates are reported by the county as 100%." },
    ...
    { countyfp: "047", name: "Merced", profile: 'fullmodel', outoforder: "Vote-by-mail rates are reported by the county as 100%."},
    ...
    { countyfp: "063", name: "Plumas", profile: 'lite', outoforder: "This county is exclusively vote-by-mail."},
    ...
    { countyfp: "091", name: "Sierra", profile: 'lite', outoforder: "This county is exclusively vote-by-mail."},
    ...
    { countyfp: "099", name: "Stanislaus", profile: 'fullmodel', outoforder: "Vote-by-mail rates are reported by the county as 100%."},
    { countyfp: "101", name: "Sutter", profile: 'fullmodel', outoforder: "Vote-by-mail rates are reported by the county as 100%."},
    { countyfp: "103", name: "Tehama", profile: 'fullmodel', },
    { countyfp: "105", name: "Trinity", profile: 'fullmodel', outoforder: "Vote-by-mail rates are reported by the county as 100%."},
