...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp: "001", name: "Alameda", profile: 'fullmodel', outoforder: ""},
    { countyfp: "003", name: "Alpine", profile: 'lite', outoforder: "This county is exclusively all vote-by-mail in every election."},
    { countyfp: "005", name: "Amador", profile: 'fullmodel', outoforder: "vca"},
    ...
    { countyfp: "009", name: "Calaveras", profile: 'fullmodel', outoforder: "vca"},
    { countyfp: "011", name: "Colusa", profile: 'fullmodel', },
    { countyfp: "013", name: "Contra Costa", profile: 'fullmodel', outoforder: ""},
    { countyfp: "015", name: "Del Norte", profile: 'fullmodel', },
    { countyfp: "017", name: "El Dorado", profile: 'fullmodel', outoforder: "vca"},
    { countyfp: "019", name: "Fresno", profile: 'fullmodel', outoforder: "vca"},
    ...
    { countyfp: "029", name: "Kern", profile: 'fullmodel', outoforder: ""},
    ...
    { countyfp: "039", name: "Madera", profile: 'fullmodel', outoforder: "vca"},
    { countyfp: "041", name: "Marin", profile: 'fullmodel', },
    { countyfp: "043", name: "Mariposa", profile: 'fullmodel', outoforder: "vca"},
    ...
    { countyfp: "055", name: "Napa", profile: 'fullmodel', outoforder: "vca"},
    { countyfp: "057", name: "Nevada", profile: 'fullmodel', outoforder: "vca"},
    { countyfp: "059", name: "Orange", profile: 'fullmodel', outoforder: "vca"},
    ...
    { countyfp: "067", name: "Sacramento", profile: 'fullmodel', outoforder: "vca"},
    ...
    { countyfp: "073", name: "San Diego", profile: 'inprogress', outoforder: "Updated modeling of suggested voting locations is in progress for this county. Currently modeled voting locations for the 2020 General Election are available."},
    ...
    { countyfp: "081", name: "San Mateo", profile: 'fullmodel', outoforder: "vca"},
    { countyfp: "083", name: "Santa Barbara", profile: 'fullmodel', },
    { countyfp: "085", name: "Santa Clara", profile: 'fullmodel', outoforder: "vca"},
    ...
    { countyfp: "109", name: "Tuolumne", profile: 'fullmodel', outoforder: "vca"},
