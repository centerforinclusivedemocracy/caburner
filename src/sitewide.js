...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp: "001", name: "Alameda", profile: 'inprogress', outoforder: "Updated modeling of suggested vote locations is in progress for this county. In the meantime, previously modeled suggested vote locations are available."},
    ...
    { countyfp: "013", name: "Contra Costa", profile: 'inprogress', outoforder: "Updated modeling of suggested vote locations is in progress for this county. In the meantime, previously modeled suggested vote locations are available."},
    ...
    { countyfp: "029", name: "Kern", profile: 'inprogress', outoforder: "Updated modeling of suggested vote locations is in progress for this county. In the meantime, previously modeled suggested vote locations are available."},
    ...
    { countyfp: "037", name: "Los Angeles", profile: 'inprogress', outoforder: "Updated modeling of suggested vote locations is in progress for this county. In the meantime, previously modeled suggested vote locations are available."},
    ...
    { countyfp: "059", name: "Orange", profile: 'inprogress', outoforder: "Updated modeling of suggested vote locations is in progress for this county. In the meantime, previously modeled suggested vote locations are available."},
    ...
    { countyfp: "085", name: "Santa Clara", profile: 'inprogress', outoforder: "Updated modeling of suggested vote locations is in progress for this county. In the meantime, previously modeled suggested vote locations are available."},
