...
const PARTICIPATING_COUNTIES = [
    ...
    { countyfp: "003", name: "Alpine", profile: 'lite', outoforder: "This county is exclusively all vote-by-mail in every election.", vca: '3 & 4'},
    { countyfp: "005", name: "Amador", profile: 'fullmodel', vca: '2'},
    { countyfp: "007", name: "Butte", profile: 'lite', datafootnote: "Note: Census data may not reflect current population for this county.", outoforder: "Due to recent changes to the county population, we are not providing voting location suggestions for this county.", vca: '2'},
    ...
    { countyfp: "037", name: "Los Angeles", profile: 'inprogress', outoforder: "Updated modeling of suggested voting locations is in progress for this county. Currently modeled voting locations for the 2020 General Election are available.", vca: '2'},
    ...
    { countyfp: "059", name: "Orange", profile: 'fullmodel', vca: '2'},
    { countyfp: "061", name: "Placer", profile: 'fullmodel', vca: '3 & 4'},
    { countyfp: "063", name: "Plumas", profile: 'lite', outoforder: "This county is exclusively all vote-by-mail in every election.", vca: '3 & 4'},
    ...
    { countyfp: "071", name: "San Bernardino", profile: 'inprogress', outoforder: "Updated modeling of suggested voting locations is in progress for this county. Currently modeled voting locations for the 2020 General Election are available.", vca: '3 & 4'},
    { countyfp: "073", name: "San Diego", profile: 'inprogress', outoforder: "Updated modeling of suggested voting locations is in progress for this county. Currently modeled voting locations for the 2020 General Election are available.", vca: '3 & 4'},
    ...
    { countyfp: "091", name: "Sierra", profile: 'lite', outoforder: "This county is exclusively all vote-by-mail in every election.", vca: '3 & 4'},
