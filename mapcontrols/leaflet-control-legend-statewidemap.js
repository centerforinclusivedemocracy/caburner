...
L.Control.StatewideMapLegend = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this.container.innerHTML += `<div class="legend-entry"><span class="legend-swatch legend-swatch-vca"></span> Suggested Voting Locations for Voter's Choice Act Counties</div>`;
        ...
        this.container.innerHTML += '<div class="legend-entry"><span class="legend-swatch legend-swatch-vbm"></span> Vote By Mail Counties</div>';
